...
const previews = [
  ...
  { name:'TechView', image:'/projects/techview-dashboard.jpg?v=2', kind:'Interfaz del sistema · Visión artificial', short:'Ver. Detectar. Orientar.', text:'Software de asistencia visual con detección de objetos en tiempo real (YOLOv8, OpenCV) y alertas por voz ejecutándose sobre Raspberry Pi 5. Proyecto en equipo premiado con mención de honor en 2026.', color:'#8cb8aa', url:'https://github.com/FakeCxbas/TechView' },
